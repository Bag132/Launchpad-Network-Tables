...
def start(lp=launchpad.LaunchpadMk2):
    stopthreads = False
    from button import Button
    def fratarget():
        interval = 0
    ...
    try:
        ...
        # Make base
        lp.LedCtrlXY(2, 8, 200, 2, blue=2)  # Force back
        lp.LedCtrlXY(3, 8, 200, 2, blue=2)
        lp.LedCtrlXY(4, 8, 200, 2, blue=2)  # Force front
        # Make arm
        lp.LedCtrlXY(3, 7, 3, 0, blue=1)  # Pivot
